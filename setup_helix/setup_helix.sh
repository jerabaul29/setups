...
which cargo
if [ $? -eq 0 ]; then
    echo "Cargo is working out of the box"
    ...
    ~/.cargo/bin/cargo install --git https://github.com/blopker/codebook codebook-lsp
    ~/.cargo/bin/cargo install --git https://github.com/erasin/hx-lsp hx-lsp
fi
